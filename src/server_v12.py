...
_PROJECTS_ROOT = os.path.expanduser("~/Desktop/Cld")
  ...
  <div class="tab on" id="tab-chat">
    ...
    <div class="preview-col" id="previewCol">
      ...
      <div class="preview-body" id="previewBody" style="position:relative">
        ...
        <div id="previewErrBanner" style="display:none;position:absolute;bottom:0;left:0;right:0;background:#2a0d0d;color:#ffb4b4;font:11px/1.5 ui-monospace,Menlo,monospace;padding:8px 12px;border-top:2px solid #e05050;display:none;align-items:flex-start;gap:8px;z-index:999">
          <span style="flex:1;white-space:pre-wrap;word-break:break-all" id="previewErrText"></span>
